    ...
    <SafeAreaView style={[styles.container, { backgroundColor: c.background }]}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <Text style={[styles.subtitle, { color: c.textMuted }]}>Start your financial journey with FinFlow</Text>
          ...
          <TouchableOpacity testID="register-submit-btn" onPress={handleRegister} disabled={loading} style={[styles.submitBtn, { backgroundColor: c.income }]}>
          ...
          <View style={styles.switchRow}>
            ...
            <TouchableOpacity testID="goto-login-btn" onPress={() => router.replace('/login')}>
